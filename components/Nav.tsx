...
const links = [
  ...
  { href: "/add", label: "Add Job", icon: "M12 4v16m8-8H4" },
  { href: "/upload", label: "Upload PDF", icon: "M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" },
];
    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[var(--card)] border-b border-[var(--border)] px-6 py-3">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <span className="text-xl font-bold tracking-tight">GP Production</span>
        </Link>
